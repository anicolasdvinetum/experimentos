...
Viendo la página de jaeger, dice "Your applications must be instrumented before they can send tracing data to Jaeger. We recommend using the OpenTelemetry instrumentation and SDKs". Asumo que se refiere a que la aplicación tiene que generar los "logs" (trazas) de algún modo, en concreto usando OpenTelemetry
